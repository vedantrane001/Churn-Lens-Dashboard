...
def build_tenure_bar(tenure_val, monthly_val):
    ...
    fig.update_layout(
        ...
        paper_bgcolor="#111520",
        plot_bgcolor="#111520",
        xaxis=dict(gridcolor="#1e2540", linecolor="#1e2540", tickfont=dict(size=10, color="#8892a4")),
        yaxis=dict(gridcolor="#1e2540", linecolor="#1e2540", tickfont=dict(size=10, color="#4a5568"),
                   title="Avg Churn %", titlefont=dict(size=9, color="#4a5568")),
        showlegend=False,
    )
